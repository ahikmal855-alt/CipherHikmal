...
function validateInput(inputBits, keyBits) {
  if (inputBits.length !== 8 || !onlyBinary(inputBits)) {
    showError("Input plaintext/ciphertext harus berupa bilangan biner 8-bit. Contoh: 11010111");
    return false;
  }

  if (keyBits.length !== 10 || !onlyBinary(keyBits)) {
    showError("Kunci harus berupa bilangan biner 10-bit. Contoh: 1010000010");
    return false;
  }
...
exampleBtn.addEventListener("click", function () {
  ...
  // Contoh mengikuti materi: plaintext 11010111 dengan key 1010000010
  // menghasilkan ciphertext 10101000. Jika mode dekripsi dipilih,
  // aplikasi otomatis mengisi ciphertext tersebut agar hasilnya kembali ke plaintext.
  keyBitsEl.value = "1010000010";

  if (mode === "decrypt") {
    inputBitsEl.value = "10101000";
  } else {
    inputBitsEl.value = "11010111";
  }
